  ...
  return (
    <Form.Group style={{ width: "99%" }}>
      <Row>
        <Col xs={24} sm={12}>
          <Form.ControlLabel>
            Company <span style={{ color: "#ff6b6b" }}>*</span>
          </Form.ControlLabel>
      ...
      <Row>
        <Col xs={24}>
          <Form.ControlLabel>
            Joining Date <span style={{ color: "#ff6b6b" }}>*</span>
          </Form.ControlLabel>
          <Input
            max={today}
            value={jDate}
        ...
        <Col xs={24}>
          ...
          {(eDate.length ? eDate < jDate : false) && !working ? (
            <Form.HelpText style={{ color: "#ff6b6b" }}>
              How could you quit before joining?
            </Form.HelpText>
          ) : (
            ""
          )}
      ...
      <Form.HelpText>
        <span style={{ color: "#ff6b6b" }}>*</span> marked fields are required.
      </Form.HelpText>
    </Form.Group>
  );
}
