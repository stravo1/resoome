...
function FormInput(props) {
  ...
  return (
    <div style={{ padding: isBigScreen ? "2rem" : "1rem" }}>
      ...
      <Form>
        <span style={styles.title}>Personal Details</span>
        <p style={{ paddingTop: "0.5rem" }}>Information about you.</p>
        <br />
        <Form.Group>
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            >
              <UserInfo style={{ fontSize: "2rem", opacity: "0.5" }} />
            </div>
            <Uploader
              value={photo}
              accept="image/*"
        ...
        <br />
        <Form.Group>
          <p style={styles.title}>Profile Summary</p>
          <p>
            A short description about yourself, your ideals and your interests.(
